...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site footer managed from Strapi';
    displayName: 'Footer';
    pluralName: 'footers';
    singularName: 'footer';
  };
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site navigation managed from Strapi';
    displayName: 'Navbar';
    pluralName: 'navbars';
    singularName: 'navbar';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'layout.navbar-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::navbar.navbar'
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A frontend page composed of dynamic-zone blocks';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
